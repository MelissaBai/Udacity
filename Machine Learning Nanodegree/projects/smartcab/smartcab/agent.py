...
class LearningAgent(Agent):
    ...
    def choose_action(self, state):
        ...
        # Learning and taking a random action
        if random.random() < self.epsilon:
            return random.choice(self.valid_actions)

        # Learning and taking the action with the highest Q-value,
        # choosing randomly between actions with the highest value
        # if there is a tie.
        maxQ = self.get_maxQ(state)
        actions = [a for a in self.Q[state] if self.Q[state][a] == maxQ]
